        ...
        <form id="form-setting1">
            <div class="card" id="settings-card">
                     ...
                     <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">NSS/NSM</label>
                ...
                <a href="https://www.wieistmeineip.de/cometo/?de"><img src="https://www.wieistmeineip.de/ip-adresse/?size=468x60" 
border="0" width="550" height="80" alt="IP" /></a>           
        </form>
		 </div>
